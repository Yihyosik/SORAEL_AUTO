// =======================
// index.js — Soraiel v5.0 (최종 안정화 버전)
// =======================
require('dotenv').config();
const fs = require('fs/promises'); // 비동기 FS 모듈 사용
...
app.post('/chat', async (req, res) => {
  ...
  try {
    ...
    const aiResponse = result.output?.trim() || result.returnValues?.output?.trim() || "응답 실패";
